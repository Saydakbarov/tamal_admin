...
import AddSubCategory1 from "./AddSubCategory";
...
export default function SubCategoryTable1() {
  ...
  useEffect(() => {
    fetch(`${BASE_URl}api/v1/subcategories?limit=20&offset=` + offset, {
      method: "GET",
      headers: {},
    })
      .then((res) => res.json())
            ...
            {subCategoryData1?.map((row, i) => (
              <StyledTableRow key={row.sub_category_id}>
                ...
                <StyledTableCell align="center">
                  ...
                  >
                    <UpdateSubCategory data={updateCategory} />
                    <Box>
                      <DeleteSubCategory id={updateCategory} />
                    </Box>
                  </Box>
                </StyledTableCell>
              </StyledTableRow>
